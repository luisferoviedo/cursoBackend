...
function clearStoredSession() {
  // Limpieza de emergencia usada por el interceptor cuando el backend rechaza la sesión.
  // La idea es dejar al cliente en un estado coherente antes de redirigir o avisarle a App.
  setAuthToken(null)
...
export function setUnauthorizedHandler(handler) {
  // React registra aquí la función que debe correr si la API responde 401.
  // Así evitamos importar componentes o hooks dentro de esta capa de infraestructura.
  unauthorizedHandler = handler
}

export function getApiErrorMessage(error, fallbackMessage) {
  // Normaliza errores de red para que las pantallas trabajen con un solo mensaje final.
